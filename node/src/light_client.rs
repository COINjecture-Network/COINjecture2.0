...
pub use crate::light_sync::{
    FlyClientError, FlyClientProof, LightClientVerifier, MMRInclusionProof, VerificationResult,
};
...
impl LightClientState {
    ...
    pub fn with_mode(
        ...
        let flyclient_verifier =
            if matches!(sync_mode, LightSyncMode::FlyClient | LightSyncMode::Hybrid) {
    ...
    pub async fn verify_flyclient_proof(
        &self,
        ...
        let verifier = verifier_guard
            .as_mut()
            .ok_or(FlyClientError::VerificationFailed(
                "FlyClient not enabled".into(),
            ))?;
    ...
    pub async fn validate_header_chain(
        &self,
        from: u64,
        to: u64,
    ) -> Result<bool, LightClientError> {
...
pub enum LightClientMessage {
    ...
    GetHeaderByHash { hash: Hash, request_id: u64 },
    ...
    NewHeader { header: BlockHeader },

    /// Request current tip
    GetTip { request_id: u64 },
...
impl LightClientSync {
    ...
    pub async fn create_header_request(
        &self,
        from_height: u64,
        count: u64,
        peer_id: String,
...
impl HeaderServer {
    ...
    pub async fn handle_get_header_by_hash(
        &self,
        _hash: Hash,
        request_id: u64,
    ) -> LightClientMessage {
    ...
    pub async fn handle_get_spv_proof(
        &self,
        tx_hash: Hash,
        block_hash: Hash,
        request_id: u64,
