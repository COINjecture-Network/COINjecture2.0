                ...
                >
                  ...
                  <span className="text-left">
                    ...
                    <span className="block text-xs font-normal text-muted-foreground">
                      New email, password, and email confirmation
                    </span>
                  </span>
                </Button>
                <Button
          ...
          {phase === 'email' && (
            <>
              <DialogHeader className="pr-8">
                ...
                <DialogDescription>
                  {emailMode === 'signup' &&
                    'Choose a password (min. 8 characters). New sign-ups may need email confirmation before they can continue.'}
                  {emailMode === 'signin' && 'Use the email and password for your account.'}
                  {emailMode === 'magic' &&
                    'We’ll email a one-time sign-in link if this address is registered.'}
                </DialogDescription>
              </DialogHeader>
