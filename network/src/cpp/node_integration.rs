...
impl CppNodeType {
    ...
    pub fn can_serve_sync(&self) -> bool {
        matches!(self, CppNodeType::Full | CppNodeType::Archive | CppNodeType::Validator)
    }
    ...
    pub fn can_solve_bounties(&self) -> bool {
        matches!(self, CppNodeType::Bounty | CppNodeType::Full | CppNodeType::Validator)
    }
}
...
mod tests {
    ...
    fn test_reward_multipliers() {
        ...
        assert!(CppNodeType::Validator.reward_multiplier() > CppNodeType::Oracle.reward_multiplier());
    ...
    fn test_message_priorities() {
        ...
        assert_eq!(CppNodeType::Validator.default_priority(), MessagePriority::D1_Critical);
        
        // Light nodes get lower priority
        assert_eq!(CppNodeType::Light.default_priority(), MessagePriority::D5_Background);
        
        // Archive nodes get archive priority
        assert_eq!(CppNodeType::Archive.default_priority(), MessagePriority::D7_Archive);
    }
