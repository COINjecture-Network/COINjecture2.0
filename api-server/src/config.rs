...
pub struct Config {
    ...
    /// Optional comma-separated JSON-RPC URLs tried **first** for `chain_getMiningWork` only
    /// (e.g. `http://node1:9933` when bootnode is a non-mining RPC front).
    pub mining_rpc_url: Option<String>,
...
impl Config {
    ...
    pub fn from_env() -> Result<Self, String> {
        Ok(Config {
            ...
            mining_rpc_url: std::env::var("MINING_RPC_URL").ok(),
